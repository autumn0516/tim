...
**📱 完美支持移动端**: 在手机、平板上也能轻松创作视频！
**🎨 可视化工作流**: 拖拽节点设计视频生成流程，像搭积木一样简单！
...
- 📱 **移动端优化**: 完美支持手机和平板，触摸友好，自动压缩图片
- 🎨 **可视化工作流**: Canvas画布节点编辑器，拖拽连接设计视频流程
...
详细使用说明请查看：
- 📖 [Web应用文档](web_app/README.md)
- 📱 [移动端使用指南](MOBILE.md)
- 🎨 [工作流编辑器指南](WORKFLOW.md)
